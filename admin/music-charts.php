...
$pageTitle = 'Music Charts Management';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'fetch_all') {
        try {
            ...
            $success = 'Music charts fetched for all African countries!';
        } catch (Exception $e) {
    ...
    <main class="main-content">
        <header class="top-bar">
            <div class="top-bar-left">
                ...
                <h2 class="page-title">Music Charts</h2>
            </div>
        ...
        <nav class="breadcrumbs">
            ...
            <span class="breadcrumb-current">Music Charts</span>
        </nav>
                            ...
                            <table style="width: 100%; border-collapse: collapse;">
                                <thead>
                                    <tr style="background: rgba(0, 0, 0, 0.05);">
                                        ...
                                        <th style="padding: 1rem; text-align: left;">Streams</th>
                                        <th style="padding: 1rem; text-align: left;">Weeks</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($charts as $chart): ?>
                                        <tr>
                                            <td style="padding: 1rem; border-bottom: 1px solid var(--glass-border);"><?php echo $chart['rank']; ?></td>
                                            <td style="padding: 1rem; border-bottom: 1px solid var(--glass-border);"><?php echo htmlspecialchars($chart['title']); ?></td>
                                            <td style="padding: 1rem; border-bottom: 1px solid var(--glass-border);"><?php echo htmlspecialchars($chart['artist']); ?></td>
                                            <td style="padding: 1rem; border-bottom: 1px solid var(--glass-border);"><?php echo number_format($chart['streams']); ?></td>
                                            <td style="padding: 1rem; border-bottom: 1px solid var(--glass-border);"><?php echo $chart['weeks_on_chart']; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    ...
                                    <?php if (empty($charts)): ?>
                                        <tr>
                                            <td colspan="5" style="text-align: center; padding: 3rem; color: var(--text-secondary);">
                                                No charts data for this country/date. Click "Fetch All Countries" to fetch data.
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
